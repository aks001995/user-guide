    ...
    const sendMessage = async () => {
        ...
        try {
            const res = await axios.post(
                "http://localhost:3000/assistant/message",
                {
                    userMessage: userMsg,
                    uiMetadata: meta,
                }
                ...
                <Box sx={modalStyle}>
                    ...
                    >
                        <Typography variant="h6">
                            Hi, I'm DiNA 👋 How can I help you?
                        </Typography>
                    ...
                    <Box
                        ref={scrollRef}
                        sx={{ flex: 1, overflowY: "auto", mb: 1, p: 1 }}
                    >
                        {messages.map((m, idx) => (
                            <Box
                                key={idx}
                            ...
                            >
                                ...
                                >
                                    ...
                                    {m.role === "assistant" && !m.temp && (
                                        <Button
                                            size="small"
                                            onClick={() =>
                                                startVisualDemo(m.steps, m.text)
                                            }
                                            sx={{ mt: 0.5 }}
                                        >
                                            Show Visual Demo
